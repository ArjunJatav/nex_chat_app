...
export const CaptchaModelShow = (props: any) => {
  ...
  const onCaptchaSubmit = async () => {
    if (captchaValue === "" || captchaValue === null) {
      // Alert.alert(t("Please_Enter_captcha"));
      globalThis.errorMessage =t("Please_Enter_captcha"); 
 ...
 //@ts-expect-error - add explanation here, e.g., "Expected type error due to XYZ reason"
    if (firstValue + secondValue == captchaValue) {
      ...
      setResetSlide(true);
      setCaptchaValue("");
      // Alert.alert(t("Invalid_Please_Enter_captcha"));
      globalThis.errorMessage =t("Invalid_Please_Enter_captcha"); 
      setErrorAlertModel(true);
...
<ErrorAlertModel
      ...
      >
        ...
        >
          {t("Solve_the_question_below_to_verify_youare_not_a_Robot")}{" "}
        </Text>
        ...
        >
          <Text style={{ color: firstColor, fontSize: 18, fontWeight: "bold" }}>
            {firstValue}
