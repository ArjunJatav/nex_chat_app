...
export const CameraModal = (props: any) => {
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <Text style={styles.Upload_buttonText}>{t("camera")}</Text>
          </TouchableOpacity>
          ...
          >
            ...
            />
            <Text style={styles.Upload_buttonText}>{t("gallary")}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.upload_button]}
          ...
          >
            ...
            />
            <Text style={styles.Upload_buttonText}>{t("cancel")}</Text>
          </TouchableOpacity>
        </View>
      </View>
    </Modal>
