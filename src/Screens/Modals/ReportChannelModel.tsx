...
export const ReportChannelModel = (props: any) => {
  ...
  const styles = StyleSheet.create({
    ...
    nameInputTextContainer: {
      marginRight: 6,
      marginLeft: DeviceInfo.isTablet() == true ? 32 : 6,
  ...
  function checkIfValidReason() {
    if (reason.length > 0) {
      props.report_user(reason);
      setreason("");
    } else {
      //Alert.alert(t("report_reason_required"));
      globalThis.errorMessage = t("report_reason_required");
      setErrorAlertModel(true);
      // Alert.alert(
      //   t("error"), // The title of the alert
      //   t("report_reason_required"), // The message body
