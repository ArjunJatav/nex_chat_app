...
export const ErrorInviteUserModel = (props: any) => {
      ...
      >
        ...
        >
          ...
          <TouchableOpacity style={styles.button} onPress={props.cancelButton}>
            ...
            <TouchableOpacity style={styles.button} onPress={props.inviteButton}>
              <Text style={styles.buttonText}>{t("Invite User")}</Text>
            </TouchableOpacity>
          </View>
          </View>
