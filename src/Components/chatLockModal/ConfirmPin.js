...
const ConfirmPinModal = ({ isVisible, onClose, onPinEntered,onSubmit }) => {
  const pinLength = 4;
  return (
    <Modal
      transparent={true}
    ...
    >
      <TouchableOpacity style={styles.modalContainer} onPress={() => onClose()} activeOpacity={0.7}>
        <TouchableOpacity style={styles.modalContent} activeOpacity={1}>
          <Text style={styles.title}>{t("confirm_pin")}</Text>
